...
function addRect(motor, baugruppe, einzelteil, x, y, w, h) {
    var rect = new Box2;
    rect.motor = motor;
...
function reloadMotoren() {
    ...
    for (i = 0; i < motoren.length; i++) {
        motor.options[motor.options.length] = new Option(motoren[i].kurz + ", " + motoren[i].name, motoren[i].kurz, false, false);
    }
}
